            ...
            <div className="bg-white px-8 py-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <h1 className="text-2xl font-bold mb-2 text-gray-900">✏️ Edit Profile</h1>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  />
                  <label className="ml-3 text-sm font-medium text-gray-700">📧 Email Notifications</label>
                </div>
                <div className="flex items-center">
                  <input
                    type="checkbox"
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <label className="ml-3 text-sm font-medium text-gray-700">🌙 Dark Mode</label>
                </div>
              </div>
            </div>
